package com.example.nicolaskermagoret.boxofficeclean.getMovieList.services;
...
//    Observable<MovieEntityFull> getMovie(@Path("id") String id, @Query("language") String language);
